...
def dec_remainder_of_two_floats(f_dividend, f_divisor)
    return (f_dividend / f_divisor) - (f_dividend / f_divisor).floor 
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
    return  (dec_remainder_of_two_integers(i_dividend, i_divisor) * i_divisor).ceil
end
